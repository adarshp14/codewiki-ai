...
const DEMO_FLOW_CHART = `graph TD
  A[Code Repository] --> B[CodeWiki AI]
...
const DEMO_SEQUENCE_CHART = `sequenceDiagram
  participant User
  participant CodeWiki AI
  participant GitHub

  User->>CodeWiki AI: Enter repository URL
  CodeWiki AI->>GitHub: Request repository data
  GitHub-->>CodeWiki AI: Return repository data
  CodeWiki AI->>CodeWiki AI: Process and analyze code
  CodeWiki AI-->>User: Display wiki with diagrams

  %% Add a note to make text more visible
  Note over User,GitHub: CodeWiki AI supports sequence diagrams for visualizing interactions`;
...
export default function Home() {
  ...
  const [repositoryInput, setRepositoryInput] = useState('https://github.com/AsyncFuncAI/codewiki-ai-open');
        ...
        <div
          ...
          <div
            ...
            <div className="grid grid-cols-1 gap-3 text-xs text-[var(--muted)]">
              ...
              >https://github.com/AsyncFuncAI/codewiki-ai-open
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
        ...
        <div
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-5">
              <a href="https://github.com/AsyncFuncAI/codewiki-ai-open" target="_blank" rel="noopener noreferrer"
