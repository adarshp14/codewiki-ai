...
app = FastAPI(
    title="CodeWiki AI API",
    description="AI-powered documentation generator API",
    version="1.0.0",
    docs_url="/docs" if os.getenv("NODE_ENV") != "production" else None,  # Hide docs in production
    redoc_url="/redoc" if os.getenv("NODE_ENV") != "production" else None,  # Hide redoc in production
)

# Configure CORS for production security
ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Development
    "https://codewiki-ai.vercel.app",  # Production Vercel
    "https://www.codewiki-ai.com",  # Custom domain
]
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "codewiki-ai-backend.onrender.com",
    "www.codewiki-ai.com",
    "codewiki-ai.com"
]
...
async def health_check():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            health_status["ollama_version"] = response.json().get("version", "unknown")
        else:
...
async def get_ollama_status():
    ...
    try:
        ...
        version_response = requests.get(f"{ollama_host}/api/version", timeout=5)
        ...
        return {
            ...
            "models_ready": "nomic-embed-text" in models
        }
