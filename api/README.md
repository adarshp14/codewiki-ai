...
This is the backend API for CodeWiki AI, providing smart code analysis and AI-powered documentation generation.
...
CodeWiki AI supports multiple LLM providers. The environment variables above are required depending on which providers you want to use:
...
##### Configuration Files
CodeWiki AI now uses JSON configuration files to manage various system components instead of hardcoded values:
...
```
CODEWIKI_AI_CONFIG_DIR=/path/to/custom/config/dir  # Optional, for custom config file location
```
...
# Request data
payload = {
    "repo_url": "https://github.com/AsyncFuncAI/codewiki-ai-open",
    "messages": [
        {
            "role": "user",
